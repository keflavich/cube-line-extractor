...
def cubelinemoment(cube,cuberegion,spatialmaskcube,spatialmaskcuberegion,vz,target,brightest_line,width_line,width,noisemapbright_baseline,noisemap_baseline,my_line_list,my_line_widths,my_line_names,signal_mask_limit,spatial_mask_limit):
